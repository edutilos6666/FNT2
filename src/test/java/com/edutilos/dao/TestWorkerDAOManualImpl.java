 ...
 */
public class TestWorkerDAOManualImpl {

    private WorkerDAOManualImpl dao;

    public TestWorkerDAOManualImpl() {
        dao = new WorkerDAOManualImpl();
    }
    ...
    public void tearDown() {
        ...
        temp.addAll(all);
        for(Worker w: temp) dao.remove(w.getId());
    }
